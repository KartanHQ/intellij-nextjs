package com.nekofar.milad.intellij.nextjs.diagnostic
...
class NextErrorReportSubmitter : ErrorReportSubmitter() {
    ...
    private fun getReportBody(events: Array<out IdeaLoggingEvent>, additionalInfo: String?): String {
        ...
        val plugin = PluginManagerCore.getPlugin(PluginId.getId("com.nekofar.milad.intellij.nextjs"))
    ...
    private fun getReportIssueUrl(title: String, body: String): URI? {
        val uriBuilder = URIBuilder("https://github.com/KartanHQ/intellij-nextjs/issues/new")
